...
10 hand-crafted structural features used for LR probing:
...
```bibtex
@article{
  title={Shortcuts or Semantics? Probing Knowledge-Gating Benchmarks via Lightweight Feature Analysis},
  year={2026}
}
```
