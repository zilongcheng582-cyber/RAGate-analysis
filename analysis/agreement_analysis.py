...
前置条件：
    - results/mha_predictions.csv（从 AutoDL 下载）
...
输出：
    results/agreement_results.csv     — 每个样本的 label/lr_pred/mha_pred
    results/agreement_summary.txt     — 统计摘要（论文用）
"""
...
KETOD_TRAIN    = "data/ketod/train_features.csv"
KETOD_TEST     = "data/ketod/test_features.csv"
MHA_PRED_CSV   = "results/mha_predictions.csv"   # 从 AutoDL 下载到本地
