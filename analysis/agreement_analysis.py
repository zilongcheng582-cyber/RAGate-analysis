...
前置条件：
    ...
    - results/mha_predictions.csv（generated by mha/mha_inference.py, or copied from an external training environment into results/）
...
MHA_PRED_CSV   = "results/mha_predictions.csv"   # generated by mha/mha_inference.py, or copied from an external training environment into results/
=======
